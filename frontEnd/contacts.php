...
<div class="jumbotron">
  <h1>User Registration & Searching</h1>
</div>
<div class = "container">
<div class = "row">
  <div class="col-lg-6">
    <form action= "usersql.php" method="post">
...
<div class ="form-group">
        <label>Home Address</label>
          <textarea class="form-control" name="haddr">
            </textarea>
 </div>
<div class ="form-group">
        <label>Home Phone</label>
          <input type="text" name="hphone" autocomplete="off" class="form-control">
      </div>

<div class ="form-group">
        <label>Cell Phone</label>
          <input type="text" name="cphone" autocomplete="off" class="form-control">
      </div>  
