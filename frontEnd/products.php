...
<div class="card">
  <img class="card-img-top" src="images/Book1.jpg" alt="Card image">
  <div class="card-body">
    <h4 class="card-title">Apka Bunty</h4>
    <p class="card-text">A book by renowned hindi writter Manu Bhandari</p>
